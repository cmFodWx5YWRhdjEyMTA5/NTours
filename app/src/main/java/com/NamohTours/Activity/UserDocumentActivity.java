...
public class UserDocumentActivity extends AppCompatActivity {
    ...
    private static final String TAG = UserDocumentActivity.class.getSimpleName();
    private SharedPreferences preferences, RegisterPrefences;
    private String restoreToken, CustomerId, tempName, tempUrl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        custDocs = (RecyclerView) findViewById(R.id.custDocsRecyclerView);
        custDocs.setLayoutManager(new LinearLayoutManager(UserDocumentActivity.this));
        custDocs.addItemDecoration(new DividerItemDecoration(UserDocumentActivity.this, DividerItemDecoration.HORIZONTAL));

        txtNodocs = (TextView) findViewById(R.id.txtNoDocs);
        // Token
        ...
        if (ConnectionDetector.isConnectingToInternet(getApplicationContext())) {
            ...
            Call<GetUserUploadDocumentsResponse> call = apiInterface.getUserDocumentListByCustId(restoreToken, new GetUserUploadDocumentsResponse(CustomerId));

            call.enqueue(new Callback<GetUserUploadDocumentsResponse>() {
                @Override
                public void onResponse(Call<GetUserUploadDocumentsResponse> call, final Response<GetUserUploadDocumentsResponse> response) {
                    ...
                    if (response.body().getSuccess()) {
                        ...
                        if (response.body().getData().size() > 0 && response.body().getData() != null) {
                            ...
                            custDocs.setAdapter(new CustomerUploadedDocsAdapter(docsList, R.layout.list_item_cust_docs, UserDocumentActivity.this, new ClickListener() {
                                @Override
                                public void onClick(int position) {
                                    ...
                                    //  new DownloadFileFromURL().execute(docsList.get(position).getFullFileName());
                                    ...
                                    if (!newFile.exists()) {
                                        ...
                                        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                                            ...
                                            // Else Ask for Permission
                                                ...
                                                ActivityCompat.requestPermissions(UserDocumentActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, WRITE_EXTERNAL);
                                            }
    ...
    private void askForPermission(String permission, Integer requestCode) {
        if (ContextCompat.checkSelfPermission(UserDocumentActivity.this, permission) != PackageManager.PERMISSION_GRANTED) {

            // Should we show an explanation?
            if (ActivityCompat.shouldShowRequestPermissionRationale(UserDocumentActivity.this, permission)) {

                //This is called if user has denied the permission before
                //In this case I am just asking the permission again
                ActivityCompat.requestPermissions(UserDocumentActivity.this, new String[]{permission}, requestCode);
        ...
        // permission already granted
            ...
            if (permission.equals(Manifest.permission.READ_EXTERNAL_STORAGE)) {
                ...
                new DownloadFileFromURL().execute(tempUrl);
            }
    ...
    private class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            Intent again = new Intent(UserDocumentActivity.this, UserDocumentActivity.class);
            startActivity(again);
            finish();
    ...
    private void openFile(String docName) {
        ...
        String mainPath = Environment.getExternalStorageDirectory() + "/" + "NamohDocs/Customer/" + CustomerId;
