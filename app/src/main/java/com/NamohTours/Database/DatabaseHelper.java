...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String WISHTABLE_NAME = "WISHLIST";
    ...
    public static final String _proID = "_id";
    public static final String PRODUCT_ID = "product_id";

    // Database Information
    static final String DB_NAME = "GNotification.db";
    ...
    public static final String[][] WISH_COLUMNS = new String[][]{{_proID, TYPE_PRIMARY_KEY}, {PRODUCT_ID, TYPE_TEXT}};
 ...
 /*   private static final String CREATE_TABLE = "create table " + TABLE_NAME +
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(createTable(WISHTABLE_NAME, WISH_COLUMNS));
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS " + WISHTABLE_NAME);
        onCreate(db);
    }
}
